package com.example.movieappfrontendtask.feature_movie_app.presentation.common.component
...
import com.example.movieappfrontendtask.core.presentation.ui.theme.AquaBlue
import com.example.movieappfrontendtask.core.presentation.ui.theme.ButtonBlue
import com.example.movieappfrontendtask.core.presentation.ui.theme.gothicA1
import com.example.movieappfrontendtask.feature_movie_app.presentation.common.AppConstant
        ...
        when {
            isExpanded -> {
                textWithMoreLess = buildAnnotatedString {
                    ...
                    withStyle(SpanStyle(ButtonBlue)) {
                        append(" See less")
                    }
                    pop()
                }
